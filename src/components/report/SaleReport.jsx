                        ...
                        <div className="col-lg-12 col-md-12 mt-5">
                            <div className="card shadow border-0">
                                <div className="report p-5 text-center">
                                    <h2 className="mb-3">Total: {Total.Total > 0 ? <CurrencyFormat value={Total.Total} displayType={'text'} thousandSeparator={true} prefix={'$ '} /> : 0}</h2>
                                            ...
                                            <tbody>
                                                {dataList.map((item, index) => (
                                                    <tr key={index}>
                                                        ...
                                                        <td>{item.UnitCost}</td>
                                                        <td><CurrencyFormat value={item.Total} displayType={'text'} thousandSeparator={true} prefix={'$ '} /></td>
                                                        {/* <td>{item.Note}</td>
